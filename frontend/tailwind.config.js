      ...
      colors: {
        ...
        status: {
          ...
          attendance: {
            ...
            text_active: 'rgb(var(--tk-status-attendance-text-active) / <alpha-value>)',
            text_inactive: 'rgb(var(--tk-status-attendance-text-inactive) / <alpha-value>)',
          },
        },
        overlay: {
